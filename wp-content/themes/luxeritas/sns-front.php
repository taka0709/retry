...
<!--linkedin-->
<li class="linkedin"><a href="//www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo THK_HOME_URL; ?>&amp;title=<?php echo $title; ?>&amp;summary=<?php echo thk_encode( apply_filters( 'thk_create_description', '' ) ); ?>" title="Share on LinkedIn" target="_blank" rel="nofollow noopener"><i class="<?php echo $fab, $fa_linkedin; ?>">&nbsp;</i><?php if( $icon_only !== true ): ?><span class="snsname">LinkedIn</span><?php if( $cnt_enable === true ): ?><span class="<?php echo $cls_cnt; ?> linkedin-count"><i class="<?php echo $fas; ?> fa-share-alt"></i></span><?php endif; ?><?php endif; ?></a></li>
...
?>
<li id="cp-button-bottoms" class="cp-button"><a title="Copy" onclick="luxeUrlCopy();return false;"><i class="<?php echo $fas, $fa_link; ?>">&nbsp;</i><?php if( $icon_only !== true ): ?><span class="cpname">Copy</span><?php if( $cnt_enable === true ): ?><span class="<?php echo $cls_cnt; ?> clipboard-check">-</span><?php endif; ?><?php endif; ?></a></li>
<?php
	}
} ?>
</ul>
