 ...
 *---------------------------------------------------------------------------*/
// header
add_filter( 'thk_head', function() use( $luxe, $_is ) {
...
// sidebar
add_filter( 'thk_sidebar', function( $col = null ) use( $luxe, $_is ) {
	if( $_is['feed'] === true ) return;
...
// footer
add_filter( 'thk_footer', function() use( $luxe, $_is ) {
	if( $_is['feed'] === true ) return;
...
add_filter( 'thk_create_description', function( $pid = null, $len = 100 ) use( $luxe, $_is ) {
	$p = '';
