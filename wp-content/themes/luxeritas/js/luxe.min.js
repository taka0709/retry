!function(d){var n=d.createElement('link');n.async=!0;n.defer=!0;n.rel="stylesheet";n.href="//takahiro-kimura.com/wp-content/themes/luxeritas/style.async.min.css?v=1567359760";if(d.getElementsByTagName('head')[0]!==null){d.getElementsByTagName('head')[0].appendChild(n);}
...
try{var sms=d.querySelectorAll('a[href^="#"]');Array.prototype.forEach.call(sms,function(a){if(a.getAttribute('href')!=="#"){a.addEventListener('click',function(){smoothScroll.scrollTo(this.getAttribute('href'),500);});}});}catch(e){console.error('smooth.scroll.error: '+e.message);}
